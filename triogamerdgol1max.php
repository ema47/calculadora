                            ...
                            <div class="col-md-4" style="padding-top: 1px;">
                                <div class="col-md-12">
                                    <center>
                                        ...
                                        <span
                                            style="font-size: 36px;font-weight: 800;  display: inline-block; font-family: sans-serif; color: #2e9fe1;">L1MAX
                                            +</span>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table text-center">
                                            ...
                                            <tbody>
                                                ...
                                                <td>
                                                    <button
                                                        style="font-size: 1.2em;background-color: #2e9fe1; color: white;font-weight: bold; padding: 10px 20px; border: none; border-radius: 5px;">S/.158</button>
                                                </td>
