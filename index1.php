                                    ...
                                    <div id="panelWIN" class="panel">
                                        <div class="page-header">
                                            <div class="centered-images">
                                                <img src="assets/triowinsub1.png" alt="TRIO WIN1" class="img-top">
                                            </div>
                                            <center>
                                                <img src="assets/triowin1.png" alt="TRIO WIN" class="img-center">
                                            </center>
                                        </div>
                        </main>
                                                ...
                                                <tbody>
                                                    ...
                                                    <td style="background-color: #FE580A;">
                                                        <button
                                                            ...
                                                            <br><span class="small-text1">Sujeto a evaluación crediticia</span>
                                                            </button>
                                                    </td>
                                                </tbody>
                                                <tbody>
                                                ...
                                                <tbody>
                                                    ...
                                                    <td style="background-color: #FE580A;">
                                                        <button
                                                            style="font-size: 1.2rem;background-color: #FE580A; color: white;font-weight: bold; padding: 10px 20px; border: 1px solid #FE580A; border-radius: 5px;">Solicita
                                                            el cableado
                                                            de 2 Mesh GRATIS<br><span class="small-text1"> (solo para el plan de 1000 Mbps)</span>
                                                            </button>
                                                    </td>
                                                </tbody>
                                        </div>
