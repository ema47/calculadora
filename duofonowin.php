                            ...
                            <div class="col-md-4" style="padding-top: 1px;">
                                <div class="col-md-12">
                                    <center>
                                        ...
                                        <span
                                            style="font-size: 36px;font-weight: bold;  display: inline-block; font-family: sans-serif; color: #321712;">Básico+</span>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table text-center">
                                            <thead>
                                                <th>
                                                    <button
                                                        style="font-size: 1.2em;background-color: #ff6600; color: white;font-weight: bold; padding: 10px 20px; border: none; border-radius: 5px;">WIN
                                                        PRO</button>
                                            ...
                                            <tbody>
                                                ...
                                                <td>
                                                    <button
                                                        style="font-size: 1.2em;background-color: #ff6600; color: white;font-weight: bold; padding: 10px 20px; border: none; border-radius: 5px;">-</button>
                                                </td>
                                            ...
                                            <tbody>
                                                ...
                                                <td>
                                                    <button
                                                        style="font-size: 0.9em;background-color: #321712; color: white;font-weight: bold; padding: 10px 20px; border: none; border-radius: 5px;">Por 6 mes</button>
                                                </td>
                            ...
                            <div class="col-md-4" style="padding-top: 1px;">
                                <div class="col-md-12">
                                    <center>
                                        ...
                                        <span
                                            style="font-size: 36px;font-weight: bold;  display: inline-block; font-family: sans-serif; color: #f4691c;">Básico</span>
                                    </center>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <td>
                                                    <span class="big-number-custom1"><span
                                                            class="checkmark">&#10003;</span> Más de 40 canales locales
                                            ...
                                            <tbody>
                                                <td>
                                                    <span class="big-number-custom1"><span
                                                            class="checkmark">&#10003;</span> Disfrútalo hasta en 4
                                                        dispositivos
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <td>
                                                    <span class="big-number-custom1"><span
                                                            style="font-size: 1.2em;color:#ff6600;">★</span> 800 Mbps
                                            ...
                                            <tbody>
                                                <td>
                                                    <span class="big-number-custom1"><span
                                                            style="font-size: 1.2em;color:#ff6600;">★</span> 1000 Mbps
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <div class="image-with-text">
                                            <img src="assets/wintvbasico.png" alt="Descripción de la imagen"
                                                class="img-fluid">
                                            <div class="overlay">
                                                <div class="text">WINTV Básico</div>
                                            </div>
                                        </div>
                                        <!--<div class="row mb-3">
                                            <div class="col-md-12">
