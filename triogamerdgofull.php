                                    ...
                                    <div class="page-header" style="background-color: #212120;">
                                            <center>
                                                <div style="text-align: center;line-height: 1.2;">
                                                    ...
                                                    <span
                                                        style="font-size: 85px; font-weight: 800; display: inline-block; font-family: Open Sans,sans-serif; color: white;">TRÍO
                                                    </span>
                                                    <span
                            ...
                            <div class="col-md-4" style="padding-top: 1px;">
                                <div class="col-md-12">
                                    <center>
                                        ...
                                        <span
                                            style="font-size: 36px; font-weight: 800; display: inline-block; font-family: sans-serif; color: #2e9fe1;">+
                                            D</span>
                                        <span
                                            style="font-size: 36px; font-weight: 800;  display: inline-block; font-family: sans-serif; color: #ff8300;">GO</span>
                                        <span
                                            style="font-size: 36px;font-weight: 800;  display: inline-block; font-family: sans-serif; color: #2e9fe1;">Full
                                            +</span>
                                        <i class="bi bi-telephone" style="font-size: 3.0rem;color: #ff8300;"></i>
                                    </center>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table text-center">
                                            <thead>
                                                <th>
                                                    <button
                                                        style="font-size: 1.2em;background-color: #ff6600; color: white;font-weight: bold; padding: 10px 20px; border: none; border-radius: 5px;">PLAN<br>GAMER
                                                        </button>
                                            ...
                                            <tbody>
                                                ...
                                                <td>
                                                    <button
                                                        style="font-size: 1.2em;background-color: #2e9fe1; color: white;font-weight: bold; padding: 10px 20px; border: none; border-radius: 5px;">S/.180</button>
                                                </td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <td>
                                                    <span class="big-number-custom1"><span
                                                            class="checkmark-custom2">&#10003;</span> Más de 18 canales
                                                        en vivo para DGO Plan L1MAX
                                                    </span><br>
                                            ...
                                            <tbody>
                                                <td>
                                                    <span class="big-number-custom1"><span
                                                            class="checkmark-custom2">&#10003;</span> Más de 60 canales
                                                        en vivo para DGO Plan BASICO
                                                    </span><br>
                                            ...
                                            <tbody>
                                                <td>
                                                    <span class="big-number-custom1"><span
                                                            class="checkmark-custom2">&#10003;</span> Más de 85 canales
                                                        en vivo para DGOFull
                                                    </span><br>
                                            ...
                                            <tbody>
                                                <td>
                                                    <span class="big-number-custom1"><span
                                                            class="checkmark-custom2">&#10003;</span> 02 Dispositivos en
                                                        simultáneo (DGO L1MAX y BASICO)
                                                    </span><br>
                                            ...
                                            <tbody>
                                                <td>
                                                    <span class="big-number-custom1"><span
                                                            class="checkmark-custom2">&#10003;</span> 04 Dispositivos en
                                                        simultáneo DGO FULL
                                                    </span><br>
                                            ...
                                            <tbody>
                                                <td>
                                                    <span class="big-number-custom1"><span
                                                            class="checkmark-custom2">&#10003;</span> Con DGO podras
                                                        crear hasta 5 perfiles</span><br>
                                            ...
                                            <tbody>
                                                <td>
                                                    <span class="big-number-custom1"><span
                                                            class="checkmark-custom2">&#10003;</span> Retroceder la
                                                        programacion en curso *Aplica para DGO Full. No aplica para
                                                        canales Premium (Liga 1 Max</span><br>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <table class="table text-center">
                                                ...
                                                <tbody>
                                                    ...
                                                    <td style="background-color: #FE580A;">
                                                        <img src="assets/fonowin1.png" alt="Descripción de la imagen"
                                                    ...
                                                    <td style="background-color: #FE580A;">
                                                        <button
                                                            ...
                                                            activo tu servicio de telefonía fija. </button>
                                                    </td>
                                                </tbody>
                                                <tbody>
                                                    <td style="background-color: #FE580A;">
                                        ...
                                        <div class="image-with-text-custom1">
                                            <img src="assets/dgofull.png" alt="Descripción de la imagen"
                                                class="img-fluid">
                                            <div class="overlay-custom1">
                                                <div class="text">DGOFull</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
