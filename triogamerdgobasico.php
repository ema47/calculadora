                            ...
                            <div class="col-md-4" style="padding-top: 1px;">
                                <div class="col-md-12">
                                    <center>
                                        ...
                                        <span
                                            style="font-size: 36px;font-weight: 800;  display: inline-block; font-family: sans-serif; color: #2e9fe1;">Básico +</span>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <div class="image-with-text-custom1">
                                            <img src="assets/dgobasico.png" alt="Descripción de la imagen"
                                                class="img-fluid">
                                            <div class="overlay-custom1">
                                                <div class="text">DGOBásico</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
